...
gamma_thr = 12# self-collision threshold for Gamma
...
if __name__ == "__main__":
    ...
    try:
        ...
        plt.plot(times, height_diffs, label="Height Difference to Target", color="blue")
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig('../output/height_difference_to_target_plot_wide.png')
        plt.show()
