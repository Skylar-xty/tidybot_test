...
class Panda:
    def __init__(self, stepsize=1e-3, realtime=0, connection_mode=p.GUI, urdf_path=None):
        ...
        if urdf_path is None:
            ...
            # urdf_path = os.path.join("/Users/stav.42/f_lab/vpp_tidybot/models/urdf/tidybot/base_fix.urdf")
        ...
        self.dof               = self.arm_dof + self.base_prism_joints
        self.all_indices = list(range(self.dof))
    ...
    def reset(self):
        ...
        self.target_pos = [0.0, 0.0, 0.669, -0.346, -0.742, -1.66, -0.367, 2.3, 1.99]
